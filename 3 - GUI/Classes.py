...
class Categorie : 
    ...
    def __init__(self, id_categorie, id_parent, name_categorie) :
    ...
    def get_instances(cursor) :
        ...
        for row in cursor.fetchall() :
            id_categorie, id_parent, name_categorie = row
            categorie_instance = Categorie(id_categorie=id_categorie, id_parent=id_parent, name_categorie=name_categorie)
